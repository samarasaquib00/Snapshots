-- Model: photodb    Version: 1.0
-- MySQL Server Initial Configuration Script
...
--
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `photodb`.`thumbnails` (
